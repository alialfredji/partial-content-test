...
export const EXPRESS_GET = `${SERVICE_NAME}/get`
export const EXPRESS_POST = `${SERVICE_NAME}/post`
export const EXPRESS_PUT = `${SERVICE_NAME}/put`
export const EXPRESS_DELETE = `${SERVICE_NAME}/delete`
